...
class BLEU(Metric):
    ...
    def compute(self):
        ...
        result = {}
        result['bleu-1'] = self._bleu_1 / self._count
        result['bleu-2'] = self._bleu_2 / self._count
        result['bleu-3'] = self._bleu_3 / self._count
        result['bleu-4'] = self._bleu_4 / self._count
        return result
